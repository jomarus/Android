...
public class VistaDibujo extends View {
    public int x=250,y=20,ancho=150, alto=150;
    ...
    public VistaDibujo(Context context, AttributeSet attrs) {
        ...
        Shader shader = new LinearGradient(0, 0, 0, 140, Color.WHITE, Color.BLACK, Shader.TileMode.CLAMP);
        miDrawable.getPaint().setShader(shader);
